...
[📱 Скачать APK](https://github.com/RiddlerXenon/app2proxy/releases) • [🐛 Сообщить об ошибке](https://github.com/RiddlerXenon/app2proxy/issues) • [💡 Предложить функцию](https://github.com/RiddlerXenon/app2proxy/issues)
...
1. **Скачайте APK** из [релизов](https://github.com/RiddlerXenon/app2proxy/releases)
2. **Установите приложение** на устройство с root-правами
3. **Предоставьте права суперпользователя** при первом запуске
4. **Настройте ваш прокси-сервер** на указанных портах
...
- 🎨 **Улучшение UI/UX**
- 🔧 **Новые функции** управления трафиком
...
- **Releases**: [Скачать APK](https://github.com/RiddlerXenon/app2proxy/releases)
